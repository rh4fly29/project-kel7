        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="hotel-room text-center">
                    <a href="?page=fasilitas&jenis=<?= $value['jenis']; ?>" class="d-block mb-0 thumbnail"><img
                            src="images/<?= $value['gambar']; ?>" alt="Image" class="img-fluid"></a>
...
?>
    <div class="site-blocks-cover overlay" style="background-image: url(images/mercure0.jpg);" data-aos="fade"
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7 text-center" data-aos="fade">
                    <span class="caption mb-3">apa saja fasilitas Hotel Seven ??</span>
        ...
        <div class="container">
			...
			?>
                <div class="col-md-12 col-lg-12 mb-12">
                    <div class="hotel-room text-center">
                        <a href="?page=ffaa" class="d-block mb-0 thumbnail"><img src="images/<?= $value['gambar']; ?>"
