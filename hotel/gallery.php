    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <span class="caption mb-3">Seven Hotel &amp; Resort</span>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                <h2 class="mb-5">Gallery Seven Hotel</h2>
            </div>
        </div>
            ...
            <div class="col-md-4 col-lg-4 mb-6">
                <div class="hotel-room text-center">
                    <a class="d-block mb-4 thumbnail">
                        ...
                        <div class="p-4">
                            <h3 class="heading mb-3"><a href="?page=gallery&id=<?php echo $sql['id_galeri2'] ?>">
